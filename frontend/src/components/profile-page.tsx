          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="bg-glass-bg/60 border-glass-border text-muted-foreground hover:text-foreground hover:bg-glass-bg flex items-center gap-2 rounded-full border px-4 py-2 text-sm backdrop-blur-xl transition-all duration-200 dark:hover:shadow-[0_0_12px_var(--primary)/0.15]"
              >
                {theme === 'dark' ? (
                  <>
